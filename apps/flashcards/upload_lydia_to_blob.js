#!/usr/bin/env node
/**
 * Upload Lydia audio files to Vercel Blob
 * Reads all WAV files from audio_cache/cox_voice/SE_Final_Lydia_Audio and uploads them
 */
...
const CACHE_DIR = path.join(__dirname, 'audio_cache', 'cox_voice', 'SE_Final_Lydia_Audio');
const BLOB_PREFIX = 'SE_Final_Lydia_Audio';

async function uploadAudioFiles() {
    console.log('='.repeat(70));
    console.log('Vercel Blob Audio Uploader - Lydia');
    console.log('='.repeat(70));
    console.log();
    ...
    console.log();
    console.log('Blob URL base: https://1hmdoc4cfrzddig0.public.blob.vercel-storage.com/SE_Final_Lydia_Audio/');
}
