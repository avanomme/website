...
The flashcards app now supports multiple study topics with different card types. Each topic can have multiple card file options (Flash cards, Review cards, etc.).
...
├── cards.md                 # Software Engineering Flash cards
├── ml_midterm_cards.md      # Machine Learning Flash cards
...
- **Flash Cards** (`ml_midterm_cards.md`): Question-and-answer format covering individual concepts
...
- **Flash Cards** (`cards.md`): Complete SE curriculum
...
### Direct Links
- ML Flash Cards: `study.html?topic=ml_midterm&type=cards`
...
- 📝 Flash Cards - Traditional question/answer format
...
const TOPICS = {
  your_topic: {
    ...
    cardTypes: [
      { id: 'cards', label: 'Flash Cards', file: 'your_topic_cards.md' },
