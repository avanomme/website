...
Lecture 11: Software Quality Assurance (SQA)

⸻

1. Explain the process of getting ISO certified.
...
2. Briefly describe the 4 steps of Total Quality Management.
	1.	Kaizen
Continuous process improvement; make processes visible, repeatable, and measurable.
	2.	Atarimae Hinshitsu
Examine intangibles (staff turnover, morale, communication) and optimize their influence on quality.
	3.	Kansei
Study how users interact with the product and use that insight to improve user experience.
	4.	Miryokuteki Hinshitsu
Look beyond the product itself to discover new opportunities or value in related areas.

⸻

Lecture 12: Review Techniques

⸻

1. Briefly explain the difference between an error and a defect.
...
2. Explain the concept of defect amplification.
...
3. Explain the concept of pair programming, including what motivates this approach.
...
4. Describe the steps of a formal technical review and who participates.
...
Lecture 13: Testing Conventional Applications

⸻

1. What do we look for when designing a good test?
...
2. Briefly describe white-box versus black-box testing.
...
3. Explain the process of Basis Path Testing.
...
4. Explain equivalence partitioning and what values to choose.
...
8. Explain Top-Down, Bottom-Up, and Sandwich Testing.
...
Lecture 14: Process Models

⸻

1. Describe, in detail, the Waterfall Model, including phases and pros/cons.
...
2. Evolutionary vs Throwaway Prototyping.
...
3. Strengths and weaknesses of prototyping.
...
4. Briefly describe the Spiral Model with pros/cons.
...
5. Describe the Unified Process (UP).
...
Lecture 15: People Management in Traditional Process Models

⸻

1. Explain the MOI approach to team leadership.
...
2. Describe the 4 team organizational paradigms.
	1.	Closed Paradigm:
Hierarchical; management makes decisions; low team autonomy.
	2.	Random Paradigm:
Self-organizing; team members choose roles; high autonomy; innovation-driven.
	3.	Open Paradigm:
Mix of closed + random; team communicates freely, management makes big decisions.
	4.	Synchronous Paradigm:
Tasks decomposed into many parallel independent units; heavy coordination overhead.

⸻

3. What are the three generic traditional team organization models?
...
4. Explain why setting expectations too high creates toxicity.
...
Lecture 16: Agile Processes — Underlying Goals, Values and Principles

⸻

1. Explain continuous innovation.
...
2. Traditional vs Agile focus: compliance vs delivery.
...
3. Documentation as proof of compliance.
...
4. Budgeting when requirements change constantly.
...
Lecture 17: Agile Processes — General Steps

⸻

1. Describe a Product Vision Box.
...
2. Describe an Elevator Test Statement.
...
3. Main elements of a Product Data Sheet (at least 6).
...
5. Difference between a deliverable and a milestone.
...
6. Prioritizing features: what comes first?
	1.	Dependencies
	2.	Risk
	3.	Customer value
...
8. Principle of Frequent Integration.
...
10. Oscillation problem in iterative development.
...
Lecture 18: Agile Process Models

⸻

1. Explain Extreme Programming (XP).
...
3. Principle of Extremes — give 4 examples.
...
4. Explain the Scrum model with advantages/disadvantages.
...
5. Scrum is agnostic on documentation and rigor. Explain.
...
6. “Bad decisions are better than no decisions.” Explain.
...
8. The 3 questions in daily stand-ups.
...
9. Compare XP and Scrum; highlight differences.
...
10. Describe Agile Modeling (AUP) with pros/cons.
...
11. Guidelines of Agile Modeling (at least 4).
	•	Attack risks early
...
Lecture 19: People Management in Agile Process Models
...
2. Self-organizing adaptive teams.
...
3. Responsibilities of an agile team leader.
...
4. Division of responsibility between customer team and developer team.
...
6. Participatory vs consensus decision making.
...
1. Briefly comment on the difference between traditional and agile models.
...
2. Scenario-based model selection.

For each scenario (provided in exam):
	•	Choose based on requirements stability
	•	Project size
	•	Risk level
	•	Timeline rigidity
