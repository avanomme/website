...
@desc_bp.route("/schedule/add", methods=["POST"])
...
@desc_bp.route("/schedule/edit", methods=["POST"])
...
@desc_bp.route("/schedule/delete", methods=["POST"])
...
def vocals_page():
    ...
    return render_template(
        "descendants/vocal_breakdown.html",
        active_page="vocals",
        breakdown=breakdown,
        cast_chars=cast_chars,
        actors=actors,
...
def rehearsal_log_page():
    ...
    return render_template(
        "descendants/rehearsal_log.html",
        active_page="log",
        entries=entries,
        cast_chars=cast_chars,
        character_groups=CHARACTER_GROUPS,
